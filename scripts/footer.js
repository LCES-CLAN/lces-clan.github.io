...
(function() {
  var html =
    '<footer class="footer">' +
      ...
      '<p style="margin-top:0.5rem;opacity:0.25;font-size:0.5rem;max-width:1000px;margin-left:auto;margin-right:auto;line-height:1.4;">This site uses cookies to track visits and send data to the clan Discord. Data is not shared with any third parties.</p>' +
    '</footer>';
